##all the config info will be added
...
class TrainingPipelineConfig:  ##parameter/constants/data needed for Training stage
...
class DataIngestionConfig: ##parameter/constants/data needed for Ingestion stage
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.training_file_path :str = os.path.join(
                                                     self.data_ingestion_dir,
                                                     training_pipeline.DATA_INGESTION_INJESTED_DIR,
...
class DataValidationConfig: ##parameter/constants/data needed for Validation stage
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
...
class DataTransformationConfig: ##parameter/constants/data needed for Validation stage
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
