...
class DataTransformation:
    def __init__(self, data_validation_artficat : DataValidationArtifact ,
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        ...
        and returns a Pineline object with the KNN Imputer object as the first step
        ...
        try:
            imputer : KNNImputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS) ## ** since it is key-value pair KWARGS
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            ##read data from valid train and test file
            ...
            ##replacing all -1 value with 0, since target column is hving -1 and 1
